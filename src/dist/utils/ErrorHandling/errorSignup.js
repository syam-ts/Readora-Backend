...
exports.signupError = void 0;
const signupError = (credentials) => {
    ...
    if (!passwordRegex.test(password)) {
        throw new Error("Password must be 8-10 characters long, contain at least 1 lowercase letter and 1 number.");
    }
    return;
};
